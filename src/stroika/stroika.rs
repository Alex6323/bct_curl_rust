...
/// Evaluates the Troika hash function on the input with a variable number of rounds of the permutation.
...
fn simd_export_value(nr: u32, t: &Trit) -> u8 {
    ...
    unimplemented!()
    //#[cfg(simd_size_128)]
	//return (_mm_movepi64_pi64(((t.lo >> nr) & 0x1) | ((((t.lo ^ t.hi) >> nr) & 0x1) << 1))[0] & 0xff) as u8;
}
