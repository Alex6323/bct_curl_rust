...
impl Curl {
    ...
    pub fn absorb(&mut self, trits: &[i8], mut offset: usize, mut length: usize) {
        loop {
            ...
            self.state[0..chunk_length]
                .copy_from_slice(&trits[offset..offset + chunk_length]);
    ...
    pub fn squeeze(&mut self, trits: &mut [i8], mut offset: usize, mut length: usize) {
        loop {
            ...
            trits[offset..offset + chunk_length]
                .copy_from_slice(&self.state[0..chunk_length]);
    ...
    fn transform(&mut self) {
        ...
        for _ in 0..self.num_rounds {
            ...
            for state_index in 0..STATE_LENGTH {
                ...
                self.state[state_index] = TRUTH_TABLE[(self.scratchpad
                    [prev_scratchpad_index]
