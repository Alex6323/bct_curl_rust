...
const HBITS: u64 = 0xFFFF_FFFF_FFFF_FFFF;
const LBITS: u64 = 0x0000_0000_0000_0000;
const HASH_LENGTH: usize = 243;
const NONCE_LENGTH: usize = 81;
const STATE_LENGTH: usize = 3 * HASH_LENGTH;
const TX_LENGTH: usize = 2673;
const INCR_START: usize = HASH_LENGTH - NONCE_LENGTH + 4 + 27;
...
const LOW00: u64 = 0xDB6DB6DB6DB6DB6D; //0b1101101101101101101101101101101101101101101101101101101101101101
const HIGH00: u64 = 0xB6DB6DB6DB6DB6DB; //0b1011011011011011011011011011011011011011011011011011011011011011
const LOW10: u64 ( ( (dl)0xF1F8FC7E3F1F8FC7uLL ).d ) //0b1111000111111000111111000111111000111111000111111000111111000111
const HIGH10: u64 ( ( (dl)0x8FC7E3F1F8FC7E3FuLL ).d ) //0b1000111111000111111000111111000111111000111111000111111000111111
const LOW20: u64  ( ( (dl)0x7FFFE00FFFFC01FFuLL ).d ) //0b0111111111111111111000000000111111111111111111000000000111111111
const HIGH20: u64 ( ( (dl)0xFFC01FFFF803FFFFuLL ).d ) //0b1111111111000000000111111111111111111000000000111111111111111111
const LOW30: u64  ( ( (dl)0xFFC0000007FFFFFFuLL ).d ) //0b1111111111000000000000000000000000000111111111111111111111111111
const HIGH30: u64 ( ( (dl)0x003FFFFFFFFFFFFFuLL ).d ) //0b0000000000111111111111111111111111111111111111111111111111111111
const LOW40: u64  ( ( (dl)0xFFFFFFFFFFFFFFFFuLL ).d ) //0b1111111111111111111111111111111111111111111111111111111111111111
const HIGH40: u64 ( ( (dl)0xFFFFFFFFFFFFFFFFuLL ).d ) //0b1111111111111111111111111111111111111111111111111111111111111111
const LOW50: u64  ( ( (dl)0xFFFFFFFFFFFFFFFFuLL ).d ) //0b1111111111111111111111111111111111111111111111111111111111111111
const HIGH50: u64 ( ( (dl)0xFFFFFFFFFFFFFFFFuLL ).d ) //0b1111111111111111111111111111111111111111111111111111111111111111

const LOW01: u64  ( ( (dl)0x6DB6DB6DB6DB6DB6uLL ).d ) //0b0110110110110110110110110110110110110110110110110110110110110110
const HIGH01: u64 ( ( (dl)0xDB6DB6DB6DB6DB6DuLL ).d ) //0b1101101101101101101101101101101101101101101101101101101101101101
const LOW11: u64  ( ( (dl)0xF8FC7E3F1F8FC7E3uLL ).d ) //0b1111100011111100011111100011111100011111100011111100011111100011
const HIGH11: u64 ( ( (dl)0xC7E3F1F8FC7E3F1FuLL ).d ) //0b1100011111100011111100011111100011111100011111100011111100011111
const LOW21: u64  ( ( (dl)0xC01FFFF803FFFF00uLL ).d ) //0b1100000000011111111111111111100000000011111111111111111100000000
const HIGH21: u64 ( ( (dl)0x3FFFF007FFFE00FFuLL ).d ) //0b0011111111111111111100000000011111111111111111100000000011111111
const LOW31: u64  ( ( (dl)0x00000FFFFFFFFFFFuLL ).d ) //0b0000000000000000000011111111111111111111111111111111111111111111
const HIGH31: u64 ( ( (dl)0xFFFFFFFFFFFE0000uLL ).d ) //0b1111111111111111111111111111111111111111111111100000000000000000
const LOW41: u64  ( ( (dl)0x000000000001FFFFuLL ).d ) //0b0000000000000000000000000000000000000000000000011111111111111111
const HIGH41: u64 ( ( (dl)0xFFFFFFFFFFFFFFFFuLL ).d ) //0b1111111111111111111111111111111111111111111111111111111111111111
const LOW51: u64  ( ( (dl)0xFFFFFFFFFFFFFFFFuLL ).d ) //0b1111111111111111111111111111111111111111111111111111111111111111
const HIGH51: u64 ( ( (dl)0xFFFFFFFFFFFFFFFFuLL ).d ) //0b1111111111111111111111111111111111111111111111111111111111111111

const LOW02: u64  ( ( (dl)0xB6DB6DB6DB6DB6DBuLL ).d ) //0b1011011011011011011011011011011011011011011011011011011011011011
const HIGH02: u64 ( ( (dl)0x6DB6DB6DB6DB6DB6uLL ).d ) //0b0110110110110110110110110110110110110110110110110110110110110110
const LOW12: u64  ( ( (dl)0xFC7E3F1F8FC7E3F1uLL ).d ) //0b1111110001111110001111110001111110001111110001111110001111110001
const HIGH12: u64 ( ( (dl)0xE3F1F8FC7E3F1F8FuLL ).d ) //0b1110001111110001111110001111110001111110001111110001111110001111
const LOW22: u64  ( ( (dl)0xFFF007FFFE00FFFFuLL ).d ) //0b1111111111110000000001111111111111111110000000001111111111111111
const HIGH22: u64 ( ( (dl)0xE00FFFFC01FFFF80uLL ).d ) //0b1110000000001111111111111111110000000001111111111111111110000000
const LOW32: u64  ( ( (dl)0x1FFFFFFFFFFFFF80uLL ).d ) //0b0001111111111111111111111111111111111111111111111111111110000000
const HIGH32: u64 ( ( (dl)0xFFFFFFFC0000007FuLL ).d ) //0b1111111111111111111111111111110000000000000000000000000001111111
const LOW42: u64  ( ( (dl)0xFFFFFFFC00000000uLL ).d ) //0b1111111111111111111111111111110000000000000000000000000000000000
const HIGH42: u64 ( ( (dl)0x00000003FFFFFFFFuLL ).d ) //0b0000000000000000000000000000001111111111111111111111111111111111
const LOW52: u64  ( ( (dl)0xFFFFFFFFFFFFFFFFuLL ).d ) //0b1111111111111111111111111111111111111111111111111111111111111111
const HIGH52: u64 ( ( (dl)0xFFFFFFFFFFFFFFFFuLL ).d ) //0b1111111111111111111111111111111111111111111111111111111111111111

const LOW03: u64  ( ( (dl)0xDB6DB6DB6DB6DB6DuLL ).d ) //0b1101101101101101101101101101101101101101101101101101101101101101
const HIGH03: u64 ( ( (dl)0xB6DB6DB6DB6DB6DBuLL ).d ) //0b1011011011011011011011011011011011011011011011011011011011011011
const LOW13: u64  ( ( (dl)0x7E3F1F8FC7E3F1F8uLL ).d ) //0b0111111000111111000111111000111111000111111000111111000111111000
const HIGH13: u64 ( ( (dl)0xF1F8FC7E3F1F8FC7uLL ).d ) //0b1111000111111000111111000111111000111111000111111000111111000111
const LOW23: u64  ( ( (dl)0x0FFFFC01FFFF803FuLL ).d ) //0b0000111111111111111111000000000111111111111111111000000000111111
const HIGH23: u64 ( ( (dl)0xFFF803FFFF007FFFuLL ).d ) //0b1111111111111000000000111111111111111111000000000111111111111111
const LOW33: u64  ( ( (dl)0xFFFFFFFFFF000000uLL ).d ) //0b1111111111111111111111111111111111111111000000000000000000000000
const HIGH33: u64 ( ( (dl)0xFFF8000000FFFFFFuLL ).d ) //0b1111111111111000000000000000000000000000111111111111111111111111
const LOW43: u64  ( ( (dl)0xFFFFFFFFFFFFFFFFuLL ).d ) //0b1111111111111111111111111111111111111111111111111111111111111111
const HIGH43: u64 ( ( (dl)0xFFF8000000000000uLL ).d ) //0b1111111111111000000000000000000000000000000000000000000000000000
const LOW53: u64  ( ( (dl)0x0007FFFFFFFFFFFFuLL ).d ) //0b0000000000000111111111111111111111111111111111111111111111111111
const HIGH53: u64 ( ( (dl)0xFFFFFFFFFFFFFFFFuLL ).d ) //0b1111111111111111111111111111111111111111111111111111111111111111
